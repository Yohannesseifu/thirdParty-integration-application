...
import { type TransactionParams } from '@/shared/model/enumerations/transaction-params.model';
export interface IRequestInput {
  ...
  valueFromTransaction?: keyof typeof TransactionParams | null;
...
export class RequestInput implements IRequestInput {
  constructor(
    ...
    public valueFromTransaction?: keyof typeof TransactionParams | null,
