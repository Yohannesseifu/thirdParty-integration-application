      ...
      <table class="table table-striped" aria-describedby="responseOutputs">
        <thead>
          <tr>
            ...
            <th scope="row"><span>Is Logic Field</span></th>
            <th scope="row"><span>Constant Value To Compare</span></th>
            <th scope="row"><span>Operator To Compare Value</span></th>
        ...
        <tbody>
          <tr v-for="responseOutput in responseOutputs" :key="responseOutput.id" data-cy="entityTable">
            ...
            <td>{{ responseOutput.transferCoreMapping }}</td>
            <td>{{ responseOutput.isLogicField }}</td>
            <td>{{ responseOutput.constantValueToCompare }}</td>
            <td>{{ responseOutput.operatorToCompareValue }}</td>
            <td>{{ responseOutput.isRequired }}</td>
            <td>
