...
describe('Service Tests', () => {
  describe('ResponseOutput Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ResponseOutput(123, 'AAAAAAA', 'COLLECTION', 'AAAAAAA', 'RESPONSE', 'AMOUNT', 'AAAAAAA', 'EQUAL_TO', false);
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            coreMapping: 'BBBBBB',
            constantValueToCompare: 'BBBBBB',
            operatorToCompareValue: 'BBBBBB',
            isRequired: true,
          },
          elemDefault,
        );
