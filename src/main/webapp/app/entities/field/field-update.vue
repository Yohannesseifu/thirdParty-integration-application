    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="field-metaData">Meta Data</label>
            <select class="form-control" id="field-metaData" data-cy="metaData" name="metaData" v-model="field.metaData">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="field.metaData && fieldUIMetaDataOption.id === field.metaData.id ? field.metaData : fieldUIMetaDataOption"
