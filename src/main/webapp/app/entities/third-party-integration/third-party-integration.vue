      ...
      <table class="table table-striped" aria-describedby="thirdPartyIntegrations">
        <thead>
          <tr>
            ...
            <th scope="row"><span>Payment Success Template</span></th>
            <th scope="row"><span>Payment Error Template</span></th>
        ...
        <tbody>
          <tr v-for="thirdPartyIntegration in thirdPartyIntegrations" :key="thirdPartyIntegration.id" data-cy="entityTable">
            ...
            <td>{{ thirdPartyIntegration.paymentSuccessTemplate }}</td>
            <td>{{ thirdPartyIntegration.paymentErrorTemplate }}</td>
