...
import { RequestValueSource } from '@/shared/model/enumerations/request-value-source.model';
...
export default defineComponent({
  ...
  setup() {
    ...
    const requestValueSourceValues: Ref<string[]> = ref(Object.keys(RequestValueSource));
