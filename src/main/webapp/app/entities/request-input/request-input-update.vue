    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="request-input-autoUserValue">Auto User Value</label>
            <select
              class="form-control"
              name="autoUserValue"
              :class="{ valid: !v$.autoUserValue.$invalid, invalid: v$.autoUserValue.$invalid }"
              v-model="v$.autoUserValue.$model"
              id="request-input-autoUserValue"
              data-cy="autoUserValue"
            >
              <option v-for="autoUserValue in autoUserValueValues" :key="autoUserValue" v-bind:value="autoUserValue">
                {{ autoUserValue }}
              </option>
            </select>
          </div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="request-input-valueFromTransaction">Value From Transaction</label>
            <select
              class="form-control"
              name="valueFromTransaction"
              :class="{ valid: !v$.valueFromTransaction.$invalid, invalid: v$.valueFromTransaction.$invalid }"
              v-model="v$.valueFromTransaction.$model"
              id="request-input-valueFromTransaction"
              data-cy="valueFromTransaction"
            >
              <option v-for="transactionParams in transactionParamsValues" :key="transactionParams" v-bind:value="transactionParams">
                {{ transactionParams }}
              </option>
            </select>
          </div>
