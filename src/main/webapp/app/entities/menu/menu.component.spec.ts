  ...
  describe('Menu Management Component', () => {
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        // GIVEN
        menuServiceStub.retrieve.resolves({ headers: {}, data: [{ id: '9fec3727-3421-4967-b213-ba36557ca194' }] });
        ...
        expect(comp.menus[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
      });
    });
    describe('Handles', () => {
