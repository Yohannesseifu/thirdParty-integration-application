...
describe('Service Tests', () => {
  describe('Header Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Header('9fec3727-3421-4967-b213-ba36557ca194', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Header', async () => {
      ...
      it('should not update a Header', async () => {
      ...
      it('should partial update a Header', async () => {
      ...
      it('should not partial update a Header', async () => {
      ...
      it('should not return a list of Header', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Header', async () => {
