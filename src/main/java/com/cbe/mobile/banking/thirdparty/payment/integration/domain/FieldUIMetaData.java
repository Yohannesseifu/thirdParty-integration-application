...
public class FieldUIMetaData implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "formUi", "metaData", "integrationFieldMappings" }, allowSetters = true)
    ...
    public FieldUIMetaData id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public void setFields(Set<Field> fields) {
        if (this.fields != null) {
            this.fields.forEach(i -> i.setMetaData(null));
        }
        if (fields != null) {
            fields.forEach(i -> i.setMetaData(this));
        }
        this.fields = fields;
    }
