...
public class ResponseOutputResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ResponseOutputDTO> getResponseOutput(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteResponseOutput(@PathVariable("id") Long id) {
