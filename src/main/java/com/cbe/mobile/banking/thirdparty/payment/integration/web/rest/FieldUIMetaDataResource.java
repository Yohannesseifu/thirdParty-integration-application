...
public class FieldUIMetaDataResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<FieldUIMetaDataDTO> getFieldUIMetaData(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteFieldUIMetaData(@PathVariable("id") Long id) {
