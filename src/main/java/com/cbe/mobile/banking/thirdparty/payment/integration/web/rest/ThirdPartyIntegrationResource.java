...
public class ThirdPartyIntegrationResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ThirdPartyIntegrationDTO> getThirdPartyIntegration(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteThirdPartyIntegration(@PathVariable("id") Long id) {
