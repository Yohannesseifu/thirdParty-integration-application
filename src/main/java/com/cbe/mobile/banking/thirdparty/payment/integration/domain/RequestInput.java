...
public class RequestInput implements Serializable {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "value_from_transaction")
    ...
    public AutoUserValue getAutoUserValue() {
        return this.autoUserValue;
    }

    public RequestInput autoUserValue(AutoUserValue autoUserValue) {
        this.setAutoUserValue(autoUserValue);
        return this;
    }
    ...
    public TransactionParams getValueFromTransaction() {
        return this.valueFromTransaction;
    }

    public RequestInput valueFromTransaction(TransactionParams valueFromTransaction) {
        this.setValueFromTransaction(valueFromTransaction);
        return this;
    }
