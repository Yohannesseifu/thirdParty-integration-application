...
public class IntegrationOperationResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<IntegrationOperationDTO> getIntegrationOperation(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteIntegrationOperation(@PathVariable("id") Long id) {
