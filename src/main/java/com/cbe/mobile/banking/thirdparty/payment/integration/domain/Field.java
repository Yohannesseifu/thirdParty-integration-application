...
public class Field implements Serializable {
    ...
    private FieldUIMetaData metaData;
    ...
    public FieldUIMetaData getMetaData() {
        return this.metaData;
    }

    public void setMetaData(FieldUIMetaData fieldUIMetaData) {
        this.metaData = fieldUIMetaData;
    }

    public Field metaData(FieldUIMetaData fieldUIMetaData) {
        this.setMetaData(fieldUIMetaData);
        return this;
    }
