package com.cbe.mobile.banking.thirdparty.payment.integration.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.cbe.mobile.banking.thirdparty.payment.integration.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof com.cbe.mobile.banking.thirdparty.payment.integration.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof com.cbe.mobile.banking.thirdparty.payment.integration.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "com.cbe.mobile.banking.thirdparty.payment.integration"
        );
    }
}
