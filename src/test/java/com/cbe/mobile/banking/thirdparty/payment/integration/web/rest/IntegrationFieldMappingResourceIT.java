...
class IntegrationFieldMappingResourceIT {
    ...
    void createIntegrationFieldMapping() throws Exception {
        ...
        var returnedIntegrationFieldMapping = om.readValue(
            restIntegrationFieldMappingMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(integrationFieldMapping))
                )
    ...
    void createIntegrationFieldMappingWithExistingId() throws Exception {
        ...
        restIntegrationFieldMappingMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(integrationFieldMapping)))
    ...
    void putExistingIntegrationFieldMapping() throws Exception {
        ...
        restIntegrationFieldMappingMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedIntegrationFieldMapping.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedIntegrationFieldMapping))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingIntegrationFieldMapping() throws Exception {
        ...
        restIntegrationFieldMappingMockMvc
            .perform(
                put(ENTITY_API_URL_ID, integrationFieldMapping.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(integrationFieldMapping))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamIntegrationFieldMapping() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restIntegrationFieldMappingMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(integrationFieldMapping)))
    ...
    void patchNonExistingIntegrationFieldMapping() throws Exception {
        ...
        restIntegrationFieldMappingMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, integrationFieldMapping.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(integrationFieldMapping))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamIntegrationFieldMapping() throws Exception {
        ...
        restIntegrationFieldMappingMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(integrationFieldMapping))
            )
            .andExpect(status().isMethodNotAllowed());
