...
class RequestInputResourceIT {
    ...
    private static final TransactionParams DEFAULT_VALUE_FROM_TRANSACTION = TransactionParams.TRANSACTION_ID;
    private static final TransactionParams UPDATED_VALUE_FROM_TRANSACTION = TransactionParams.TRANSACTION_DETAIL;
    ...
    public static RequestInput createEntity(EntityManager em) {
        RequestInput requestInput = new RequestInput()
            ...
            .valueFromTransaction(DEFAULT_VALUE_FROM_TRANSACTION);
        return requestInput;
    }
    ...
    public static RequestInput createUpdatedEntity(EntityManager em) {
        RequestInput requestInput = new RequestInput()
            ...
            .valueFromTransaction(UPDATED_VALUE_FROM_TRANSACTION);
        return requestInput;
    }
    ...
    void getAllRequestInputs() throws Exception {
        ...
        restRequestInputMockMvc
            ...
            .andExpect(jsonPath("$.[*].valueFromTransaction").value(hasItem(DEFAULT_VALUE_FROM_TRANSACTION.toString())));
    }
    ...
    void getRequestInput() throws Exception {
        ...
        restRequestInputMockMvc
            ...
            .andExpect(jsonPath("$.valueFromTransaction").value(DEFAULT_VALUE_FROM_TRANSACTION.toString()));
    }
