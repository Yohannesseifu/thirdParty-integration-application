...
class IntegrationOperationResourceIT {
    ...
    void createIntegrationOperation() throws Exception {
        ...
        var returnedIntegrationOperation = om.readValue(
            restIntegrationOperationMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(integrationOperation)))
    ...
    void getAllIntegrationOperations() throws Exception {
        ...
        restIntegrationOperationMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(integrationOperation.getId().toString())))
    ...
    void getIntegrationOperation() throws Exception {
        ...
        restIntegrationOperationMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(integrationOperation.getId().toString()))
    ...
    void getNonExistingIntegrationOperation() throws Exception {
        // Get the integrationOperation
        restIntegrationOperationMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putExistingIntegrationOperation() throws Exception {
        ...
        restIntegrationOperationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedIntegrationOperation.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedIntegrationOperation))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingIntegrationOperation() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        integrationOperation.setId(UUID.randomUUID());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restIntegrationOperationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, integrationOperation.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(integrationOperation))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamIntegrationOperation() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restIntegrationOperationMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(integrationOperation)))
    ...
    void patchNonExistingIntegrationOperation() throws Exception {
        ...
        restIntegrationOperationMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, integrationOperation.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(integrationOperation))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamIntegrationOperation() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restIntegrationOperationMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(integrationOperation)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteIntegrationOperation() throws Exception {
        ...
        restIntegrationOperationMockMvc
            .perform(delete(ENTITY_API_URL_ID, integrationOperation.getId().toString()).accept(MediaType.APPLICATION_JSON))
