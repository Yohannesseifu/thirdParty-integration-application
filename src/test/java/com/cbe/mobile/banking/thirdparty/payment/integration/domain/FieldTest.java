...
class FieldTest {
    ...
    @Test
    void fieldUIMetaDataTest() {
        Field field = getFieldRandomSampleGenerator();
        FieldUIMetaData fieldUIMetaDataBack = getFieldUIMetaDataRandomSampleGenerator();

        field.setFieldUIMetaData(fieldUIMetaDataBack);
        assertThat(field.getFieldUIMetaData()).isEqualTo(fieldUIMetaDataBack);

        field.fieldUIMetaData(null);
        assertThat(field.getFieldUIMetaData()).isNull();
    }
