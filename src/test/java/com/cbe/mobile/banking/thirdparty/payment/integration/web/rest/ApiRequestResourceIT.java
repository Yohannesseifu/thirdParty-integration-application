...
class ApiRequestResourceIT {
    ...
    void createApiRequest() throws Exception {
        ...
        var returnedApiRequest = om.readValue(
            restApiRequestMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(apiRequest)))
    ...
    void putExistingApiRequest() throws Exception {
        ...
        restApiRequestMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedApiRequest.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedApiRequest))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingApiRequest() throws Exception {
        ...
        restApiRequestMockMvc
            .perform(
                put(ENTITY_API_URL_ID, apiRequest.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(apiRequest))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchApiRequest() throws Exception {
        ...
        restApiRequestMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(apiRequest))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamApiRequest() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restApiRequestMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(apiRequest)))
    ...
    void patchNonExistingApiRequest() throws Exception {
        ...
        restApiRequestMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, apiRequest.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(apiRequest))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamApiRequest() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restApiRequestMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(apiRequest)))
            .andExpect(status().isMethodNotAllowed());
