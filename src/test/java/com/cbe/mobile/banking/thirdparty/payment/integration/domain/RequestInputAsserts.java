...
public class RequestInputAsserts {
    ...
    public static void assertRequestInputUpdatableFieldsEquals(RequestInput expected, RequestInput actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getAutoUserValue()).as("check autoUserValue").isEqualTo(actual.getAutoUserValue()))
            ...
            .satisfies(
                e -> assertThat(e.getValueFromTransaction()).as("check valueFromTransaction").isEqualTo(actual.getValueFromTransaction())
            );
    }
