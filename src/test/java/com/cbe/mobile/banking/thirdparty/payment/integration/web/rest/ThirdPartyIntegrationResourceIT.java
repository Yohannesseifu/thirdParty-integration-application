...
class ThirdPartyIntegrationResourceIT {
    ...
    private static final String DEFAULT_PAYMENT_SUCCESS_TEMPLATE = "AAAAAAAAAA";
    private static final String UPDATED_PAYMENT_SUCCESS_TEMPLATE = "BBBBBBBBBB";

    private static final String DEFAULT_PAYMENT_ERROR_TEMPLATE = "AAAAAAAAAA";
    private static final String UPDATED_PAYMENT_ERROR_TEMPLATE = "BBBBBBBBBB";
    ...
    public static ThirdPartyIntegration createEntity(EntityManager em) {
        ThirdPartyIntegration thirdPartyIntegration = new ThirdPartyIntegration()
            ...
            .paymentSuccessTemplate(DEFAULT_PAYMENT_SUCCESS_TEMPLATE)
            .paymentErrorTemplate(DEFAULT_PAYMENT_ERROR_TEMPLATE)
    ...
    public static ThirdPartyIntegration createUpdatedEntity(EntityManager em) {
        ThirdPartyIntegration thirdPartyIntegration = new ThirdPartyIntegration()
            ...
            .paymentSuccessTemplate(UPDATED_PAYMENT_SUCCESS_TEMPLATE)
            .paymentErrorTemplate(UPDATED_PAYMENT_ERROR_TEMPLATE)
    ...
    void createThirdPartyIntegration() throws Exception {
        ...
        var returnedThirdPartyIntegration = om.readValue(
            restThirdPartyIntegrationMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(thirdPartyIntegration)))
    ...
    void getAllThirdPartyIntegrations() throws Exception {
        ...
        restThirdPartyIntegrationMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(thirdPartyIntegration.getId().toString())))
            ...
            .andExpect(jsonPath("$.[*].paymentSuccessTemplate").value(hasItem(DEFAULT_PAYMENT_SUCCESS_TEMPLATE)))
            .andExpect(jsonPath("$.[*].paymentErrorTemplate").value(hasItem(DEFAULT_PAYMENT_ERROR_TEMPLATE)))
    ...
    void getThirdPartyIntegration() throws Exception {
        ...
        restThirdPartyIntegrationMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(thirdPartyIntegration.getId().toString()))
            ...
            .andExpect(jsonPath("$.paymentSuccessTemplate").value(DEFAULT_PAYMENT_SUCCESS_TEMPLATE))
            .andExpect(jsonPath("$.paymentErrorTemplate").value(DEFAULT_PAYMENT_ERROR_TEMPLATE))
    ...
    void getNonExistingThirdPartyIntegration() throws Exception {
        // Get the thirdPartyIntegration
        restThirdPartyIntegrationMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putExistingThirdPartyIntegration() throws Exception {
        ...
        restThirdPartyIntegrationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedThirdPartyIntegration.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedThirdPartyIntegration))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingThirdPartyIntegration() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        thirdPartyIntegration.setId(UUID.randomUUID());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restThirdPartyIntegrationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, thirdPartyIntegration.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(thirdPartyIntegration))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamThirdPartyIntegration() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restThirdPartyIntegrationMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(thirdPartyIntegration)))
    ...
    void patchNonExistingThirdPartyIntegration() throws Exception {
        ...
        restThirdPartyIntegrationMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, thirdPartyIntegration.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(thirdPartyIntegration))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamThirdPartyIntegration() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restThirdPartyIntegrationMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(thirdPartyIntegration)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteThirdPartyIntegration() throws Exception {
        ...
        restThirdPartyIntegrationMockMvc
            .perform(delete(ENTITY_API_URL_ID, thirdPartyIntegration.getId().toString()).accept(MediaType.APPLICATION_JSON))
