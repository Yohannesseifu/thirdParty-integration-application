...
public class ResponseOutputAsserts {
    ...
    public static void assertResponseOutputUpdatableFieldsEquals(ResponseOutput expected, ResponseOutput actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getCoreMapping()).as("check coreMapping").isEqualTo(actual.getCoreMapping()))
            .satisfies(e -> assertThat(e.getExpectedValue()).as("check expectedValue").isEqualTo(actual.getExpectedValue()));
    }
