...
class FieldResourceIT {
    ...
    void createField() throws Exception {
        ...
        // Create the Field
        var returnedField = om.readValue(
            restFieldMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(field)))
        ...
        restFieldMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedField.getId())
                    ...
                    .content(om.writeValueAsBytes(updatedField))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingField() throws Exception {
        ...
        restFieldMockMvc
            .perform(put(ENTITY_API_URL_ID, field.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(field)))
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchField() throws Exception {
        ...
        restFieldMockMvc
            .perform(put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(field)))
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamField() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFieldMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(field)))
    ...
    void patchNonExistingField() throws Exception {
        ...
        restFieldMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, field.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(field))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithIdMismatchField() throws Exception {
        ...
        restFieldMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, UUID.randomUUID()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(field))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamField() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFieldMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(field)))
            .andExpect(status().isMethodNotAllowed());
