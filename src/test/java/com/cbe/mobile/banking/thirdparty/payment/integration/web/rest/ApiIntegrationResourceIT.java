...
class ApiIntegrationResourceIT {
    ...
    void createApiIntegration() throws Exception {
        ...
        var returnedApiIntegration = om.readValue(
            restApiIntegrationMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(apiIntegration)))
    ...
    void getAllApiIntegrations() throws Exception {
        ...
        restApiIntegrationMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(apiIntegration.getId().toString())))
    ...
    void getApiIntegration() throws Exception {
        ...
        restApiIntegrationMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(apiIntegration.getId().toString()))
    ...
    void getNonExistingApiIntegration() throws Exception {
        // Get the apiIntegration
        restApiIntegrationMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putExistingApiIntegration() throws Exception {
        ...
        restApiIntegrationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedApiIntegration.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedApiIntegration))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingApiIntegration() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        apiIntegration.setId(UUID.randomUUID());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restApiIntegrationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, apiIntegration.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(apiIntegration))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamApiIntegration() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restApiIntegrationMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(apiIntegration)))
    ...
    void patchNonExistingApiIntegration() throws Exception {
        ...
        restApiIntegrationMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, apiIntegration.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(apiIntegration))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamApiIntegration() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restApiIntegrationMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(apiIntegration)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteApiIntegration() throws Exception {
        ...
        restApiIntegrationMockMvc
            .perform(delete(ENTITY_API_URL_ID, apiIntegration.getId().toString()).accept(MediaType.APPLICATION_JSON))
