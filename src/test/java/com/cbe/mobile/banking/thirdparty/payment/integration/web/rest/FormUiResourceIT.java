...
class FormUiResourceIT {
    ...
    void getAllFormUis() throws Exception {
        ...
        restFormUiMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(formUi.getId().intValue())))
    ...
    void getFormUi() throws Exception {
        ...
        restFormUiMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(formUi.getId().intValue()))
    ...
    void getNonExistingFormUi() throws Exception {
        // Get the formUi
        restFormUiMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingFormUi() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        formUi.setId(longCount.incrementAndGet());
    ...
    void deleteFormUi() throws Exception {
        ...
        // Delete the formUi
        restFormUiMockMvc
            .perform(delete(ENTITY_API_URL_ID, formUi.getId()).accept(MediaType.APPLICATION_JSON))
