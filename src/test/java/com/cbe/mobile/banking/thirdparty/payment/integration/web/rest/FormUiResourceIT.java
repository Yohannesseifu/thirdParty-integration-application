...
class FormUiResourceIT {
    ...
    void createFormUi() throws Exception {
        ...
        // Create the FormUi
        var returnedFormUi = om.readValue(
            restFormUiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(formUi)))
    ...
    void putExistingFormUi() throws Exception {
        ...
        restFormUiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedFormUi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedFormUi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingFormUi() throws Exception {
        ...
        restFormUiMockMvc
            .perform(put(ENTITY_API_URL_ID, formUi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(formUi)))
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchFormUi() throws Exception {
        ...
        restFormUiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(formUi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamFormUi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFormUiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(formUi)))
    ...
    void patchNonExistingFormUi() throws Exception {
        ...
        restFormUiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, formUi.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(formUi))
            )
            .andExpect(status().isBadRequest());
        ...
        restFormUiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, UUID.randomUUID())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(formUi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamFormUi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFormUiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(formUi)))
            .andExpect(status().isMethodNotAllowed());
